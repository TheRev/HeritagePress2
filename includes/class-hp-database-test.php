...
class HP_Database_Test
{
    ...
    private function test_table_structure()
    {
        ...
        $expected_tables = array(
            'persons', 'families', 'children', 'events', 'eventtypes',
            'sources', 'citations', 'places', 'media', 'medialinks',
            'repositories', 'notes', 'trees', 'user_permissions', 
            'import_logs', 'associations', 'addresses', 'cemeteries',
            'albums', 'albumlinks', 'xnotes', 'notelinks', 'mostwanted',
            'mediatypes', 'states'
        );
